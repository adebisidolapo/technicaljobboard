    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-[#02000D] via-[#140047] to-[#6F00FC] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          {/* Desktop: 3-column top area | Mobile: stacked */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-14 items-start">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="inline-block rounded-3xl bg-white/95 text-[#02000D] shadow-xl border border-white/20 px-6 py-5 sm:px-8 sm:py-6">
                <img
                  src="/logo.png"
                  alt="TechnicalJobboard Logo"
                  className="h-16 sm:h-20 md:h-24 w-auto object-contain mx-auto md:mx-0"
                />
              </div>

              <p className="mt-5 text-white/90 text-sm sm:text-base max-w-md mx-auto md:mx-0">
                Discover verified{" "}
            ...
            {/* Explore + Connect (aligned better on desktop) */}
            <div className="text-center md:text-left">
