      ...
      <div className="relative bg-gradient-to-br from-[#02000D] via-[#140047] to-[#6F00FC] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="flex flex-col items-center text-center">
            {/* Logo card (DevOps-style background so logo is always visible) */}
            <div className="rounded-3xl bg-white/95 text-[#02000D] shadow-xl border border-white/20 px-6 py-5 sm:px-8 sm:py-6">
              <img
          ...
          {/* Grid (aligned properly on desktop) */}
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-14 items-start">
            {/* Explore */}
