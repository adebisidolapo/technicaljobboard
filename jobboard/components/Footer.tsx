    ...
    <footer className="relative overflow-hidden text-white">
      ...
      <div className="relative bg-gradient-to-b from-[#1A2040] via-[#141A2F] to-[#0F1426]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-6 pb-10">
          {/* Logo + tagline (closer to top + spacing under logo) */}
          <div className="flex flex-col items-center text-center">
            <img
              src="/logo.png"
              alt="TechnicalJobboard Logo"
              className="w-[260px] sm:w-[320px] md:w-[380px] lg:w-[440px] h-auto object-contain drop-shadow-[0_0_40px_rgba(111,0,252,0.35)]"
            />
          ...
          {/* Columns (pulled up closer) */}
          <div className="mt-6 md:mt-7 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 text-center">
            {/* Explore */}
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="w-full max-w-sm flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-white/55 outline-none focus:ring-2 focus:ring-[#3017D3]/60"
                />
                <button
                  type="button"
                  className="w-full sm:w-auto px-6 py-3 rounded-2xl font-semibold transition bg-gradient-to-b from-[#3017D3] to-[#2a12c0] hover:from-[#3a22e6] hover:to-[#2a12c0] shadow-[0_8px_24px_rgba(48,23,211,0.35)]"
                >
                  Join
                </button>
              </div>
              ...
              <div className="flex gap-4">
                {[FaTwitter, FaLinkedinIn, FaFacebookF, FaGithub].map((Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="h-11 w-11 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center hover:bg-white/15 transition"
