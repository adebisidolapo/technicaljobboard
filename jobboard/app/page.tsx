        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex overflow-x-auto gap-6 py-4 px-2">
            {[
              ...
              { role: "UX Researcher", company: "StartUpHub", salary: "$80k – $110k", color: "#6F00FC" },
            ].map((job) => (
              <div key={job.role} className="flex-none w-72 bg-white rounded-2xl p-6 shadow-md border-l-4 hover:shadow-xl transition" style={{ borderColor: job.color }}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <aside className="bg-gray-100 rounded-2xl p-6 h-fit shadow-lg">
              ...
              <button className="mt-4 w-full bg-[#6F00FC] hover:bg-[#8C33FD] text-white px-4 py-2 rounded-lg transition">Apply Filters</button>
            </aside>
