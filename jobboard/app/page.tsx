            ...
            {[
              {
                ...
                company: "NovaTech",
                salary: "$120k – $150k",
                desc: "Build responsive, scalable UI with React & Next.js.",
                color: "#6F00FC",
              },
              {
                ...
                company: "Launchify",
                salary: "$90k – $120k",
                desc: "Design intuitive user experiences and workflows.",
                color: "#8C33FD",
              },
              {
                ...
                company: "TechNova",
                salary: "$100k – $140k",
                desc: "Develop and optimize APIs and databases for high performance.",
                color: "#A866FE",
              },
            ].map((job, idx) => (
              <div
