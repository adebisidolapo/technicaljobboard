...
export default function Home() {
  ...
  // (Optional) reveal animation helper
  useEffect(() => {
...
<section className="relative overflow-hidden bg-[#F7F8FA]">
  ...
  {/* GREEN GLOW */}
  <div className="pointer-events-none absolute -top-32 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-emerald-500/20 blur-[140px]" />
  <div className="pointer-events-none absolute top-[220px] left-[12%] h-[420px] w-[420px] rounded-full bg-emerald-400/15 blur-[120px]" />
  <div className="pointer-events-none absolute top-[260px] right-[10%] h-[460px] w-[460px] rounded-full bg-emerald-300/15 blur-[130px]" />
  ...
  <div className="relative mx-auto max-w-7xl px-6">
    <div className="mx-auto max-w-3xl text-center py-20 md:py-24">
      ...
      <button
        ...
        className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-emerald-600 hover:underline"
      >
      ...
      <section className="relative py-16 md:py-20 bg-white overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-10 md:mb-14">
            <p className="text-sm font-semibold tracking-[0.22em] text-gray-500 uppercase">Trusted by teams</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl border border-slate-200 bg-[#FBFBFD] p-6 md:p-10">
            ...
            <div className="flex flex-wrap gap-3">
              {CATEGORIES.filter((cat) => cat.label.toLowerCase().includes(categoryQuery.toLowerCase())).map(
                (cat) => {
            ...
            {CATEGORIES.filter((cat) => cat.label.toLowerCase().includes(categoryQuery.toLowerCase())).length === 0 && (
        ...
        <div className="relative w-full">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12">
            <div>
              ...
              <p className="text-gray-600 mt-2 max-w-2xl">A curated selection of standout roles from trusted teams.</p>
            </div>
              ...
              {FEATURED_JOBS.map((job, idx) => (
                ...
                >
                  ...
                  <div className="p-6 pl-8">
                    ...
                    <p className="text-sm text-gray-600 mt-4">{job.description ?? "Great team and clear role scope."}</p>
