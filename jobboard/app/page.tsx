  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section id="empowering" className="relative py-28 overflow-hidden bg-[#F6F7FB]">
        ...
        <div className="pointer-events-none absolute -top-40 -left-40 h-[520px] w-[520px]
                        rotate-45 rounded-[72px] bg-[rgba(106,111,242,0.08)]" />
        <div className="pointer-events-none absolute -bottom-52 -right-52 h-[620px] w-[620px]
