...
<section className="relative overflow-hidden bg-[#EEF6F2]">
  ...
  <div className="relative mx-auto max-w-7xl px-6">
    <div className="mx-auto max-w-4xl text-center py-16 sm:py-20 md:py-24">
      ...
      /* ================= TRUSTED BY TEAMS (2-row carousel like screenshot) ================= */
<section className="bg-white py-20">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="mt-12 rounded-3xl border border-slate-200 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.06)] overflow-hidden relative">
      {/* subtle edge fades (like screenshot) */}
      ...
      <div className="py-12">
        ...
        <div className="marquee">
          <div className="marquee__track">
            {COMPANY_LOGOS.concat(COMPANY_LOGOS).map((logo, idx) => (
              <div
                key={`r1-${logo.src}-${idx}`}
              ...
              >
                <img
                  src={logo.src}
                  alt={logo.alt}
                  className="h-8 md:h-9 w-auto grayscale opacity-60"
                  loading="lazy"
                />
              </div>
            ))}
        ...
        {/* ROW 2 (slower + offset feel) */}
        <div className="marquee mt-10 marquee--slow">
          <div className="marquee__track">
            {COMPANY_LOGOS.slice().reverse().concat(COMPANY_LOGOS.slice().reverse()).map((logo, idx) => (
              <div
                key={`r2-${logo.src}-${idx}`}
                className="mx-10 flex items-center justify-center"
              >
                <img
                  src={logo.src}
                  alt={logo.alt}
                  className="h-8 md:h-9 w-auto grayscale opacity-55"
                  loading="lazy"
                />
              </div>
            ))}
...
<section className="relative overflow-hidden py-16 bg-[#EEF0F6]">
  {/* subtle grey backdrop fade */}
  <div className="pointer-events-none absolute inset-0">
  ...
  <div className="relative max-w-7xl mx-auto px-6">
    ...
    <div className="relative mt-10">
     ...
     {/* ================= EMPOWERING (match screenshot: bg + sizing + layout) ================= */}
<section
  id="empowering"
  className="relative overflow-hidden bg-[#F5F6FF] py-20 md:py-24"
>
  {/* background blobs */}
  <div className="pointer-events-none absolute inset-0">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
      ...
      <div className="max-w-xl">
        ...
        <p className="mt-4 text-sm md:text-base text-slate-600 leading-relaxed">
          Discover vetted Technical roles, transparent salary ranges, and trusted
          employers — all in one place designed to support long-term career growth.
        </p>
