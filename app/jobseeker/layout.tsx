    ...
    <div className="flex h-full flex-col bg-white">
      <div className="border-b border-slate-100 px-5 py-4">
        <Link href="/" onClick={close} className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-extrabold text-slate-900 leading-none">TechJobBoard</p>
      ...
      <div className="border-t border-slate-100 p-4">
        <div className="rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 p-4 text-white">
          ...
          <p className="mt-1 text-xs text-emerald-100 leading-5">
            Resume reviews, career tips, priority status.
          </p>
          <button
            type="button"
      ...
      <div className="flex min-h-screen w-full flex-col lg:pl-64">
        <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-slate-200 bg-white/95 px-4 backdrop-blur sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-extrabold text-slate-900">Jobseeker Dashboard</p>
              <p className="hidden text-xs text-slate-400 sm:block">Track your applications and job search</p>
            </div>
          </div>
