            ...
            <div className="h-full rounded-3xl border border-slate-200 bg-white p-10 shadow-sm overflow-hidden relative">
              ...
              <div className="relative">
                ...
                <p className="mt-3 text-slate-600 leading-relaxed">
                  Apply faster, save roles, and build a profile employers can find.
                </p>

                <div className="mt-8 space-y-3 text-sm text-slate-700">
                  <div>One dashboard for all applications</div>
                  <div>Save roles and return anytime</div>
                  <div>Upload and update your resume</div>
                </div>
              </div>
            </div>
          </div>
