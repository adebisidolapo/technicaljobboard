    ...
    <div className="flex min-h-[calc(100vh-136px)] items-center justify-center bg-[#F3F6FB] px-4 py-10 sm:px-6 md:min-h-[calc(100vh-112px)]">
      <div className="w-full max-w-4xl">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="hidden lg:flex flex-col justify-between rounded-3xl bg-gradient-to-br from-[var(--brand-purple)] to-indigo-700 p-10 text-white overflow-hidden relative min-h-[480px]">
            ...
            <div className="relative mt-10 rounded-2xl border border-white/20 bg-white/10 p-5">
