    ...
    <div className="flex min-h-[calc(100vh-136px)] items-center justify-center bg-[#F3F6FB] px-4 py-10 sm:px-6 md:min-h-[calc(100vh-112px)]">
      <div className="w-full max-w-4xl">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-stretch">
          <div className="relative hidden min-h-[520px] flex-col justify-between overflow-hidden rounded-3xl bg-[#0C1120] p-10 text-white lg:flex">
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs text-[var(--brand-purple)] hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
