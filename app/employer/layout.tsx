...
function SidebarItem({
  ...
  return (
    ...
    >
      <span
        className={clsx(
          "h-9 w-9 rounded-xl grid place-items-center border transition",
          active
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className="absolute -inset-2 rounded-2xl bg-[color:var(--brand-purple)/0.10] blur-xl -z-10" />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <aside className="lg:col-span-3">
            <div className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              {/* Sidebar header w/ brand color */}
              <div className="p-5 border-b border-slate-200 bg-gradient-to-b from-[color:var(--brand-purple)/0.10] to-white">
              ...
              <div className="p-3">
                ...
                {/* Sidebar footer card (brand accent, no repeated Post job) */}
