  ...
  return (
    <footer className="bg-[#0F1426] text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* TOP: 5-column row (logo + 3 link cols + compact newsletter) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-2">
            ...
            {/* compact wrapper so it never feels huge */}
        ...
        {/* BOTTOM: copyright left, socials + legal together right */}
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                aria-label="Twitter"
                title="Twitter"
                className="h-9 w-9 inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/75 hover:bg-white/10 hover:text-white transition"
              >
