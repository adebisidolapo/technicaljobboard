  ...
  return (
    <footer className="bg-[#0F1426] text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {/* BOTTOM: Stay connected full-width row */}
          ...
          <div className="lg:col-span-2">
            <div className="flex lg:justify-end items-center gap-3">
              <a
                ...
                aria-label="Twitter"
                title="Twitter"
                className="h-10 w-10 inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/80 hover:bg-white/10 hover:text-white transition"
              >
