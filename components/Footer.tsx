        ...
        <div className="py-12 border-b border-white/10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              {/* Stay connected (fixed alignment) */}
              <div className="min-w-0">
                <h3 className="text-sm font-semibold text-white/90">Stay connected</h3>

                <p className="mt-4 text-sm text-white/70 leading-relaxed">
                  Weekly roles + product updates.
                </p>

                {/* Newsletter (force consistent spacing + width) */}
                <div className="mt-4">
                ...
                {/* Social row with icons (not stacked pills) */}
                <div className="mt-5 flex items-center gap-3 text-white/70">
                  <a
                    href="#"
                    className="h-10 w-10 inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:text-white transition"
                    aria-label="Twitter"
                    title="Twitter"
                  >
          ...
          {/* Accent divider */}
          <div className="mt-10 h-px bg-gradient-to-r from-transparent via-[color:var(--brand-purple)/0.35] to-transparent" />
        </div>

        {/* Bottom */}
        <div className="py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/60">
