...
// 👇 Keep your existing look even if DB has 0 jobs
...
export default function FeaturedJobsSection() {
  ...
  const displayJobs = useMemo(() => {
    // If DB is empty or API failed, keep your UI alive with fallback
  ...
  return (
    <section id="featured" className="relative overflow-hidden py-16 bg-[#F2F4F8]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              {loading ? "Loading live jobs…" : "A curated selection of standout roles from trusted teams."}
            </p>
          </div>
        ...
        {/* Optional hint if it’s showing fallback */}
