...
export default function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/90 backdrop-blur">
      {/* Increased header height to fit a bigger logo cleanly */}
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-24 md:h-28 flex items-center justify-between">
        {/* LOGO — slightly bigger than your original, but still clean */}
        <Link href="/" className="flex items-center">
          <img
            src="/Technicaljoblogo-removebg-preview.png"
            alt="TechnicalJobboard"
            className="h-22 sm:h-24 md:h-26 w-auto object-contain"
          />
        </Link>
